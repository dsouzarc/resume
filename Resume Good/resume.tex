...
\vspace{0.1in}
%An aspiring 17 			year old looking for a career in Computer Science, 				Finance, and Economics
...
\item[Education:]Princeton High School Class of 2015, University of Michigan Introduction. to Finance (Coursera), Java for Business Applications (Mercer College), Princeton University Introduction to Algorithms (Coursera)
\item[Hackathons:]HackPrinceton 2014S, PennApps 2014S/F, YHacks 2014F
...
\begin{itemize}
	\item
		\ressubheading{Javelin Capital Markets LLC.}{July - 					September 2014}
			{High frequency trading platform for Interest Rate 				Swaps}{Software Engineering Intern}
	\begin{itemize}
...
\item
	...
	\begin{itemize}
		...
		\resitem{Analyzes how people respond in a group chat 					(time and length of reply) based on gender}
...
\begin{description}
	\item[Other:]Eagle Scout (Eagle Project over 572 hours), 		Red Cross CPR and First Aid certified, avid hiker, 				white water rafter, and skier, Ultimate Frisbee and 				table tennis lover
\end{description}
\end{document}