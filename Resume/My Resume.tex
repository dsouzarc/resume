...
\textbf{\Large Ryan D'souza}  & (609) 915 - 4930\\
23 Silvers Lane &  dsouzarc@gmail.com \\
Cranbury, NJ, 08512 & linkedin.com/in/dsouzarc\\
\end{tabular*}
\\
\resheading{Description}An aspiring 17 year old looking for a career in Computer Science, Finance, and Economics

\begin{itemize}
\item
	\ressubheading{Java}{} {}{}
	\begin{description}
	GUI/SWING, AWT, DataBase, SQL, I/O, 
	MultiThreading, Network (POST and GET Requests), Applets
	\end{description}
	\begin{itemize}
